...
|  Nominal Scenario     | New coupon is generated and added to the Subscriber's Fidelity Card.
 10 points, for each 10 euro added to the coupon's amount, are subtracted from the subscriber’s total points |
|  Variants     | - |
